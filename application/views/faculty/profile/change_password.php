<script>
    ...
    $(document).ready(function() {
        $("#manage_student").validate({
            rules: {
                old_password: {
                    remote: '<?php echo FACULTY_URL . 'profile/checkOldPassword'; ?>'
                },
                confirm_password: {
                    equalTo: "#password"
                }
...
<div class="col-md-12">
    ...
    <form action="<?php echo FACULTY_URL . 'profile/updatePassword' ?>" method="post" id="manage_student" class="form-horizontal">
