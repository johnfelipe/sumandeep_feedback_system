        ...
        $("#semester_details").change(function() {
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '<?php echo ADMIN_URL; ?>feedback/getStudentDetails/' + sid + '/S',
                        success: function(data)
                        {
...
<div class="col-md-12">
    ...
    <form action="<?php echo ADMIN_URL . 'report/feedback/facultyStudentWiseListener'; ?>" method="post" id="manage">
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <select class="form-control required" name="studentid" id="student_details">
