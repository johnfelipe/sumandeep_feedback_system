...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"<b>Toon _MENU_ regels<b/>",sZeroRecords:"No matching records found",sEmptyTable:"Geen gegevens beschikbaar",
sLoadingRecords:"Loading...",sInfo:"<b>Toon _START_ tot _END_ van _TOTAL_ regels<b/>",sInfoEmpty:"Showing 0 to 0 of 0 regels",sInfoFiltered:"(filtered from _MAX_ total regels)",sInfoPostFix:"",sInfoThousands:",",sSearch:"<b>Zoeken:<b/>",sUrl:"",oPaginate:{sFirst:"Eerste",sPrevious:"Vorige",sNext:"Volgende",sLast:"Laatste"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
